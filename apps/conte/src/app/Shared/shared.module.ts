...
@NgModule({
  declarations: [TablePaginationClientComponent, ToastComponent, GenericModalComponent, TreatmentPlanTableComponent],
  imports: [CommonModule, FormsModule, ReactiveFormsModule, NgbModule],
  exports: [TablePaginationClientComponent, ToastComponent, GenericModalComponent,TreatmentPlanTableComponent],
})
